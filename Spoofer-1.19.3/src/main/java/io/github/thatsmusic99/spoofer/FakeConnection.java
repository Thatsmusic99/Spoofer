...
public class FakeConnection extends Connection {
    ...
    public FakeConnection(SpoofedPlayer player) throws UnknownHostException {
    ...
    public void send(Packet<?> packet, @Nullable PacketSendListener packetsendlistener) {
        ...
        if (packet instanceof ClientboundPlayerChatPacket chatPacket) {
            ...
            player.getChatListeners().forEach(sender -> sender.sendMessage(Component.text(player.displayName).color(NamedTextColor.GRAY)
